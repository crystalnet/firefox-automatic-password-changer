...
describe('Player', function () {
    ...
    // blueprint only with unicode
    const blueprintOnlyUni = {'version':0,'scope':['https://github.com'],'changeProcedure':[{'action':'Click','parameters':[1216,40,774,1708,0,'https://github.com/','true']},{'action':'Click','parameters':[870,220,774,1708,0,'https://github.com/login','false']},{'action':'Input','parameters':['U',5,2,'https://github.com/login']},{'action':'Click','parameters':[794,311,774,1708,0,'https://github.com/login','false']},{'action':'Input','parameters':['C',5,3,'https://github.com/login']},{'action':'Click','parameters':[811,345,774,1708,0,'https://github.com/login','true']},{'action':'Click','parameters':[1315,33,774,1708,0,'https://github.com/','false']},{'action':'Click','parameters':[1179,251,774,1708,0,'https://github.com/','true']},{'action':'Click','parameters':[379,158,774,1708,0,'https://github.com/settings/profile','false']},{'action':'Click','parameters':[734,180,774,1708,0,'https://github.com/settings/admin','false']},{'action':'Input','parameters':['C',21,10,'https://github.com/settings/admin']},{'action':'Input','parameters':['N',21,11,'https://github.com/settings/admin']},{'action':'Input','parameters':['N',21,12,'https://github.com/settings/admin']},{'action':'Click','parameters':[673,229,774,1708,149,'https://github.com/settings/admin','true']},{'action':'Click','parameters':[1326,33,774,1708,0,'https://github.com/settings/admin','false']},{'action':'Click','parameters':[1206,263,774,1708,0,'https://github.com/settings/admin','true']}],'pwdPolicy':[{'allowedCharacterSets':{'unicode':'unicode'},'compositionRequirements':[],'minLength':7,'maxLength':15}]};
    const dataOnlyUni = JSON.stringify(blueprintOnlyUni);
    const playerOnlyUni = new Player(dataOnlyUni, schema);

    // blueprint without A-J and a-j as well as 4-9
    const blueprintShort = {'version':0,'scope':['https://github.com'],'changeProcedure':[{'action':'Click','parameters':[1216,40,774,1708,0,'https://github.com/','true']},{'action':'Click','parameters':[870,220,774,1708,0,'https://github.com/login','false']},{'action':'Input','parameters':['U',5,2,'https://github.com/login']},{'action':'Click','parameters':[794,311,774,1708,0,'https://github.com/login','false']},{'action':'Input','parameters':['C',5,3,'https://github.com/login']},{'action':'Click','parameters':[811,345,774,1708,0,'https://github.com/login','true']},{'action':'Click','parameters':[1315,33,774,1708,0,'https://github.com/','false']},{'action':'Click','parameters':[1179,251,774,1708,0,'https://github.com/','true']},{'action':'Click','parameters':[379,158,774,1708,0,'https://github.com/settings/profile','false']},{'action':'Click','parameters':[734,180,774,1708,0,'https://github.com/settings/admin','false']},{'action':'Input','parameters':['C',21,10,'https://github.com/settings/admin']},{'action':'Input','parameters':['N',21,11,'https://github.com/settings/admin']},{'action':'Input','parameters':['N',21,12,'https://github.com/settings/admin']},{'action':'Click','parameters':[673,229,774,1708,149,'https://github.com/settings/admin','true']},{'action':'Click','parameters':[1326,33,774,1708,0,'https://github.com/settings/admin','false']},{'action':'Click','parameters':[1206,263,774,1708,0,'https://github.com/settings/admin','true']}],'pwdPolicy':[{'allowedCharacterSets':{'az':'klmnopqrstuvwxyz','AZ':'KLMNOPQRSTUVWXYZ','num':'0123','special':'!\^$%\\/()=?-_,.;:#+*@[]|{}<>&`~'},'compositionRequirements':[{'kind':'must','num':1,'rule':{'description':'Must-contain-at-least 1 lower-case-letters.','regexp':'^(([^az]*)[az]([^az]*)){1,}$'}},{'kind':'must','num':1,'rule':{'description':'Must-contain-at-least 1 capital-case-letters.','regexp':'^(([^AZ]*)[AZ]([^AZ]*)){1,}$'}},{'kind':'must','num':1,'rule':{'description':'Must-contain-at-least 1 special-characters.','regexp':'^(([^special]*)[special]([^special]*)){1,}$'}}],'minLength':7,'maxLength':15}]};
    const dataShort = JSON.stringify(blueprintShort);
    ...
    describe('#validateUserPassword()', function () {
        ...
        it('should reject a password with certain ascii chars that are not in the allowed charset', function () {
            playerShort.validateUserPassword('abczde678?V', username).sat.should.be.false();
        });

        it('should accept a valid password', function () {
            playerShort.validateUserPassword('unT31!P0', username).sat.should.be.true();
        });

        it('should reject a invalid password', function () {
            playerOnlyUni.validateUserPassword('WoW😙!⇎1🌼👻₩⊕', username).sat.should.be.false();
        });
    });
