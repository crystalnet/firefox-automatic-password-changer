...
describe('Player', function () {
    ...
    describe('#_validateGeneratedPassword()', function() {
        ...
        it('should reject an overlong password', function () {
            player._validatePassword('0123456789Ab$bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb').should.not.be.ok();
        })
        ...
        it('should reject the username as password', function () {
            player._validatePassword('testusernameA$0', player.blueprint).should.not.be.ok();
        });
