...
/**
 * static access to simple-storage of firefox
 */
class simpleStorageAccess {
     ...
     */
    static createOrRestore(key, defaultValue, selfConstructFunction) {
...
module.exports = simpleStorageAccess;
