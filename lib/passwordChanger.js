    ...
    tabs.open({
        ...
        onReady: function onOpen(tab) {
            ...
            AccountlistWorker = tab.attach({
                contentScriptFile: [self.data.url("extern/jquery.min.js"), self.data.url("extern/jquery-ui.min.js"), self.data.url("AccountlistContentScript.js")]
            });
                ...
                tabs.open({
                    ...
                    onReady: function onOpen(tab) {
                        let blueprintWorker = tab.attach({
                            contentScriptFile: [self.data.url("extern/jquery.min.js"), self.data.url("extern/jquery-ui.min.js"), self.data.url("BlueprintContentScript.js")]
                        });
