...
require("sdk/passwords").store({
    ...
    formSubmitURL: "https://accounts.google.com/ServiceLoginAuth",
    username: "test31498@gmail.com",
    usernameField: "Email",
    password: "coolio1991",
...
require("sdk/passwords").store({
    ...
    formSubmitURL: "https://de.sharelatex.com/login",
    username: "berkethermann@web.de",
    usernameField: "email",
    password: "coolio19911",
    passwordField: "password"
  });
require("sdk/passwords").store({
    url: "https://twitter.com",
    formSubmitURL: "https://twitter.com/sessions",
    username: "berkethermann@web.de",
  ...
  require("sdk/passwords").store({
    ...
    formSubmitURL: "https://www.facebook.com/login.php?login_attempt=1&lwv=110",
    username: "berkethermann@web.de",
    usernameField: "email",
    password: "F6aFPd3193",
    passwordField: "pass"
...
require("sdk/passwords").store({
    url: "https://vimeo.com",
    formSubmitURL: "https://vimeo.com/log_in?ssl=0&iframe=0&popup=0&player=0&product_id=0",
    username: "test31498@gmail.com",
    usernameField: "email",
    password: "coolio1991",
    passwordField: "password"
...
panel.port.on("openAccountList", openAcclist = function(){
  ...
  tabs.open({
    ...
    onReady: function onOpen(tab) {
      ...
      // listening when user clicked on button to open the blaupausen menu
      AccountlistWorker.port.on("OpenBlaupausen",openBlaupausen = function(){
        tabs.open({
          ...
          onReady: function onOpen(tab) {
            ...
            // let build Blaupause menu dynamically
            BlaupausenWorker.port.emit("startBuildingBlaupausen", ss.storage.PWCPaths);

            // listening for deleteEntry event
            // deletes entry in simple-storage and reopens the blauausen menu
...
//change automatic password
  /* parameter :
  hashtbl: hashtable object that contains the blaupause for changing password at certain url
...
/* 
saves a blaupause-entry in simple-storage
paramter: 
key4Obj: url of website where password should be changed
myObject: Hashtable that contains the blaupause for password change
*/
...
// parameter
// key4Obj: url that is used as key in simple-storage for a hashtable with blaupause
// returns hashtable object with blaupause
...
// deletes blaupause from persistent storage if this was the last entry for this url only
// reloads accountlist 
...
// parameter:
// bp: hashtable that contains a blaupause
// url: url of wensite of blaupause
