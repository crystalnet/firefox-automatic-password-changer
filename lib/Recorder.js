...
module.exports = function Recorder(){
  ...
  this.StartRecording = function(){
    ...
    //---------------------------------------------------------------test only 
    window.addEventListener('onSubmit', submited=function(e){
      console.log("SUBMIT EVENT DETECTED");
      console.log("target id = " + e.target.id);
      console.log("target action = " + e.target.action);
    });
    //---------------------------------------------------------------test only 
  ...
  this.StopRecording = function(){
    ...
    if(userWebPath != null){
      ...
      storePasswordToFFPWManager(userWebPath);
    }
  ...
  function storePasswordToFFPWManager(hashtable){
    var url;
    var formSubmitURL;
    var username;
    var usernameField;
    ...
    for(i = 0; i < hashtable.length; i++){
      if(hashtable.getItem(i)[hashtable.getItem(i).length -1] == "Submit"){
