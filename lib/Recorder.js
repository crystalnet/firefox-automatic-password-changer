...
module.exports = function Recorder() {
    ...
    function onBlurEventHandler(e) {
        ...
        orderNumber++;
        console.error("nodeNumber is " + nodeNumber + "\n  numberInputElements is " + inputs.length +  "\n  tag is " + tag + "\n  websiteTrunk is " + websiteTrunk);
        ...
        if(tag === "U") {
            ...
            console.error("formSubmitURL is " + formSubmitURL + "\n  formActiveURL is " + formActiveURL +  "\n  username is " + username + "\n  usernameField is " + usernameField);
        }
        if(tag === "C" && !loginDone) {
            passwordField = node.name;
            console.error("passwordField is " + passwordField);
        }
        if(tag === "N") {
            password = node.value;
            console.error("new password is " + password);
        }
    }
    ...
    this.StopRecording = function () {
        ...
        if (userWebPath != null) {
            ...
            console.error("storing new password...");
            console.error(formActiveURL);
            console.error(username);
            console.error(password);
            console.error(passwordField);
            console.error(usernameField);
            console.error(formSubmitURL);
