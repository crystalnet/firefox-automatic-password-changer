...
module.exports = function Recorder(lang) {
     ...
     */
    this.startRecording = function (recordStartingPoint) {
        ...
        recStartingPoint = recordStartingPoint;
    };
    ...
    this.stopRecording = function () {
        ...
        if (userWebPath !== null) {
            ...
            if (sanityCheck(userWebPath)) {
                // store recording starting point as part of the blueprint
                // we do this after CleanUpHashtable, because the property would be gone otherwise
                userWebPath.recStartingPoint = recStartingPoint;
