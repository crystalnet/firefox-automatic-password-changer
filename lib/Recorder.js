    ...
    function buildContextMenu(loginDone) {
        if(loginDone) {
            RecordingMenu = cm.Menu({
                ...
                items: [
                    cm.Item({label: languageStrings["current password"], data: "currentPassword"}),
                    cm.Item({label: languageStrings["new password"], data: "newPassword"})
                ]
            });
        } else {
            RecordingMenu = cm.Menu({
                ...
                items: [
                    cm.Item({label: languageStrings["username slash mail"], data: "usernameOrEmail"}),
                    cm.Item({label: languageStrings["current password"], data: "currentPassword"})
                ]
            });
        }
