...
module.exports = (function blueprintStorageAccess() {
    ...
    this.saveBlueprint = function saveBlueprint(url, blueprintObject) {
        ...
        console.log(simpleStorageAccess.print(url));
    };
    ...
    this.exportBlueprint = function exportBlueprint(url) {
        ...
        window.content.alert(languageStrings.format(languageStrings["blueprint exported successfully"], name));
    };
    ...
    this.importBlueprint = function importBlueprint() {
        ...
        window.content.alert(languageStrings["blueprint imported"]);
    };
    return this;
}());