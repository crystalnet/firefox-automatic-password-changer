...
module.exports = (function blueprintStorageAccess() {
    ...
    this.exportBlueprint = function exportBlueprint(url) {
        ...
        filePicker.open(function(){
            ...
            // used filePicker.file.path instead of filePicker.file.target because the target property behaves differently
            // on MacOs
            newFile.initWithPath(filePicker.file.path);

            // file is nsIFile, data is a string
            let foStream = Cc["@mozilla.org/network/file-output-stream;1"].createInstance(Ci.nsIFileOutputStream);

            // 0x02 | 0x08 | 0x20 = write, create, truncate
            // firefox bug: on MacOs and Linux systems, the created file will not have the used permissions
            // 0x666 = RW owner, RW group, RW others
            foStream.init(newFile, 0x02 | 0x08 | 0x20, 0x0666, 0);

            // for more info see https://developer.mozilla.org/en-US/Add-ons/Code_snippets/File_I_O
