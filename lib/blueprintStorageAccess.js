    ...
    (function init() {
        simpleStorageAccess.createOrRestore(simpleStorageKey, new Hashtable(), function (obj) {
            ...
            for (let property in obj.items) {
                ...
                let hashtable = new Hashtable(obj.items[property].items);
                if (obj.items[property].hasOwnProperty("recStartingPoint"))
                    hashtable.recStartingPoint = obj.items[property].recStartingPoint;
                typedItems[property] = hashtable;
            }
