...
module.exports = function Imitator(obj,username, url){
	...
	*/
	...
	this.openNewWindow = function openNewWindow() {
	...
	this.changeAlgorithm = function changeAlgorithm() {
	...
	this.changeWebsite = function changeWebsite(link) {
	...
	*/ 
	...
	this.getMainPageFromLink = function getMainPageFromLink(link) {
	...
	*/
	this.GetpasswordList = function GetpasswordList() {
		if(pwList != null)
			return;
			...
			if(newPassword != ""){
				...
				require("sdk/passwords").store({
					...
					onComplete: function onComplete(){
						...
						hiddenWin.close();
						//TODO define languageString
						window.content.alert("Passwort wurde erfolgreich geändert");
	 ...
	 */
	//export var delete_cookie =
	this.delete_cookie = function delete_cookie(name) {
		window.content.document.cookie = name + '=; expires=Thu, 01 Jan 1970 00:00:01 GMT;';
	};

	//For testing
	this.returnHiddenWin = function returnHiddenWin() {
		return hiddenWin;
	}
};
