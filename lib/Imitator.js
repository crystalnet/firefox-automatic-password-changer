	...
	*/
	function stopImitating(reason = "unknown"){
		...
		if(actualStepNum !== maxStepNum){
			...
			let message = "Bei der Änderung des Passwords ist ein Fehler unterlaufen. Es könnte trotzdem geändert worden sein, in diesem Fall ist die Änderung aber nicht im Passwort-Manager eingetragen worden.";
			if(newPassword !== "")
				message += "Das neue Passwort wäre in diesem Fall " + newPassword;
