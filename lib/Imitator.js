...
// obj: hashtable that contains blaupause for website 
...
module.exports = function Imitator(obj,username, url){
	...
	*/
	...
	function openNewWindow(){
    	...
    	hiddenWin.getBrowser().addEventListener("DOMContentLoaded",DomContentLoadedEvent = function(){
    		...
    		// check if algotihmus is hanging up at a step
	...
	*/
	function performSubmitLogin(submitdata){
		...
		worker.port.on("ReadyLogin",function(){
			changeAlgorithm();
		});
	}
	...
	*/ 
	...
	// hash: hashtable with blaupause -> obj 
