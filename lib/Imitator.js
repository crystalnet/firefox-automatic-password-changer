	...
	*/
	this.StartImitating = function() {
        ...
        hiddenWin.getBrowser().addEventListener("DOMContentLoaded", DomContentLoadedEvent=function(){
            ...
            // use eventLock variable to prevent starting changeAlgorithm() multiple times, if
			// loading a site triggers DOMContentLoaded event more than once (e.g. accounts.google.com)
            if(!eventLock) {
                eventLock = true;
