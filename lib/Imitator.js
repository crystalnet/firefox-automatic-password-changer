 ...
 * @param generator generator object for generating new passwords
 */
module.exports = function Imitator(obj, username, url, languageStrings, generator) {
    let maxStepNum;
    let actualStepNum = 0;
    let lastStepNum = 0;
    let worker;
