...
module.exports = function BlueprintStorage() {
     ...
     * @param url url of the website corresponding to the blueprint that should be exported.
     */
    this.export = function (url) {
        let blueprint = simpleStorageAccess.getPWCPath(url);
    ...
    this.import = function () {
        ...
        let storageKey = newBlueprint.getItem(newBlueprint.length - 1);
        newBlueprint.removeItem(newBlueprint.length - 1);

        simpleStorageAccess.savePWCPath(storageKey, newBlueprint);
        //TODO define languageString
